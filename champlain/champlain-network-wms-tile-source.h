...
#define CHAMPLAIN_NETWORK_WMS_TILE_SOURCE(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST ((obj), CHAMPLAIN_TYPE_NETWORK_WMS_TILE_SOURCE, ChamplainNetworkWmsTileSource))

#define CHAMPLAIN_NETWORK_WMS_TILE_SOURCE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST ((klass), CHAMPLAIN_TYPE_NETWORK_WMS_TILE_SOURCE, ChamplainNetworkWmsTileSourceClass))

#define CHAMPLAIN_IS_NETWORK_WMS_TILE_SOURCE(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE ((obj), CHAMPLAIN_TYPE_NETWORK_WMS_TILE_SOURCE))

#define CHAMPLAIN_IS_NETWORK_WMS_TILE_SOURCE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE ((klass), CHAMPLAIN_TYPE_NETWORK_WMS_TILE_SOURCE))

#define CHAMPLAIN_NETWORK_WMS_TILE_SOURCE_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS ((obj), CHAMPLAIN_TYPE_NETWORK_WMS_TILE_SOURCE, ChamplainNetworkWmsTileSourceClass))
